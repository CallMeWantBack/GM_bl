...
{
	public partial class TemperatureSix : UIElement
	{
		...
		private void Awake()
		{
			...
			TemccInputFiled_Six.onValueChanged.AddListener(delegate
            {
                InputTxt = TemccInputFiled_Six.text;


            });
			CCbTN_Six.onClick.AddListener(() =>
            {
                if (TempNum != InputTxt)
                {
                    print(" ‰»Î¥ÌŒÛ");
